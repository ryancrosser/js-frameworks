    ...
    this.getAllData = function(params) {
      ...
      $q
        ...
        .then(function(results) {
          var combinedResults = results.reduce(function(
            previousValue,
            currentResult
          ) {
...
(function() {
  ...
  angular.module("app").component("topNavBar", {
...
(function() {
  ...
  angular.module("app").component("queryContainer", {
  ...
  function QueryContainerController(DataService, StateService) {
    ...
    this.submit = function() {
      if (this.inputs.seedsStr) {
        ...
        this.inputs.seed = this.inputs.seed.map(
      ...
      DataService.getAllData(JSON.parse(JSON.stringify(this.inputs)))
        .then(function(results) {
...
angular.module("app").run([
  ...
  function($templateCache) {
    $templateCache.put(
      "components/content/content.view.html",
    ...
    $templateCache.put(
      "components/grid/grid.view.html",
      '<div ag-grid="$ctrl.gridOptions" class="ag-fresh" style="height: 100%;"></div>\n'
    );
    $templateCache.put(
      "components/map/map.view.html",
      '<leaflet lf-center="$ctrl.mapData.center" layers="$ctrl.mapData.layers" markers="$ctrl.mapData.markers" event-broadcast="$ctrl.mapData.events"\n    defaults="$ctrl.mapData.defaults" height="100%" width="100%"></leaflet>\n'
    );
    $templateCache.put(
      "components/query-container/query-container.view.html",
    ...
    $templateCache.put(
      "components/shell/shell.view.html",
      '<top-nav-bar></top-nav-bar>\n\n<div class="container-fluid" style="padding-top: 51px;">\n    <div ui-view></div>\n</div>\n'
    );
    $templateCache.put(
      "components/top-nav-bar/top-nav-bar.view.html",
