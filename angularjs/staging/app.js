...
angular.module("app").run(["$templateCache", function($templateCache) {$templateCache.put("components/grid/grid.view.html","<div ag-grid=\"$ctrl.gridOptions\" class=\"ag-fresh\" style=\"height: 100%;\"></div>\n");
